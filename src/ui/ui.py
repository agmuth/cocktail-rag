...
import gradio as gr
from src.rag.components.chat_engine import chat_engine #TODO: move chat enginge to behind fastapi
import time
...
def main():
    ...
    demo.queue().launch(server_name=BASE_SETTINGS.GRADIO_SERVER_NAME, server_port=BASE_SETTINGS.GRADIO_SERVER_PORT)
